...
[isPath,No_Comp_4_pathway]=inferGlyForwPath_wo_specificity(substrateArray,enzArray,3);
%GlcNac_Products2=oglycanpath.getSpecies;
glycanPathViewer(No_Comp_4_pathway)
No_Comp_4_Species=No_Comp_4_pathway.getSpecies
