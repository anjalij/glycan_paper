function varargout=inferGlyProd_update3(substrObj,enzObj)
% inferGlyProd infer the product based on the substrate and enzyme.

%Not working...messed up adding to an already build substrate also leads to
%infinite addition somehow....
