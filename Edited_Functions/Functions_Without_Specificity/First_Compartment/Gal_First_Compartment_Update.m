...
%Gal_13_GlcNac_Product=glycanMLread('Gal_13_GlcNac_Product.glycoct_xml');
%Galactose_Structure=glycanMLread('Galactose_Residue.glycoct_xml');
...
%Gal_13_GlcNac.substNABranch=CellArrayList;
%Gal_13_GlcNac.substNABranch.add(Gal_13_GlcNac_Product);
%Gal_13_GlcNac.substNABranch.add(Fuc_13_GlcNac_Product);
...
%Fuc_13_GlcNac.substNABranch.add(Gal_13_GlcNac_Product);
...
%Product_Species=oglycanpath.getSpecies;
%Products=containers.Map()
%for i=1:length(Product_Species)
%    Products(i)=Product_Species.get(i).glycanStruct;
%end
